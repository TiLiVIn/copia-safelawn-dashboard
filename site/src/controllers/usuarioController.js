...
function cadastrar(req, res) {
    ...
    var gramado = req.body.gramadoServer;
...
function cadastrarClube(req, res) {
    // Crie uma variável que vá recuperar os valores do arquivo cadastro.html
    ...
    if (nome == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrarClube(nome, email, senha, cnpj, telefone, uf)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function cadastrarEndereco(req, res) {
    ...
    if (cep == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrarEndereco(cep, logradouro, numero, complemento)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
